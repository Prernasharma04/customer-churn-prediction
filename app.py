...
model = joblib.load("churn_model1.pkl")
...
avg_monthly_value = TotalCharges / tenure if tenure > 0 else 0

longTermCustomer = 1 if tenure >= 24 else 0

HighMonthlyCharge = 1 if MonthlyCharges > 80 else 0
...
input_data = {
    ...
    "HighMonthlyCharge": HighMonthlyCharge,
    ...
    "spender_type_low": 1 if spender_type == "low" else 0,

    "spender_type_medium": 1 if spender_type == "medium" else 0,
}
